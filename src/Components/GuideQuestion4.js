...
const GuideQuestion4 = ({ setContent }) => {
    ...
    return (
        <div className="guide-container">
            ...
            <h3>Cool. We’ve taken care of the physical self-care. <br />Now we’re going to deal with the emotional ones. <br /><br />Whenever you are feeling down, <br />do you know why you’re in a bad mood, or not feeling well emotionally?</h3>
